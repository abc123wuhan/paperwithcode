...
! among the user抯 personal computer systems, archival, or emergency repair 
...
program msistest
  ...
  integer, parameter          :: nrec =  200            !200
  ...
  open(77,file='H:\model.zip\model\NRLMSIS2.0\msis2.0_test_in.txt',status='old')           !路径'H:\msis-v2\msis-v2\msis2.0_test_in.txt'    E:\nrlm20_in_200911.txt
  open(78,file='E:\nrlm20_out_200911.txt',status='replace')      !路径'H:\msis-v2\msis-v2\msis2.0_test_out.txt'   E:\nrlm20_out_200911.txt
  read(77,*) dummy
  ...
  do i = 1,200                                                     !输入数据的行数
     ...
     !write(*,*) ap(1)
    ap(1) = apd
    call gtd8d(iyd,sec,alt,glat,glong,stl,f107a,f107,ap,mass,d,xtex,t)  
    write(78,'(2i7,3f7.1,f7.2,3f7.1,9e13.4,f8.2)')  &
      iyd,int(sec),alt,glat,glong,stl,f107a,f107,ap(1),d(1:9),t(2)     !t(1)
  enddo
  close(77)
  close(78)
